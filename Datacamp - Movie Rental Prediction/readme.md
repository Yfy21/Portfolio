In this project, the goal was to create a regression model to predict the number of days a customer rents DVDs for with a mean squared error (MSE) of less than 3.0.
